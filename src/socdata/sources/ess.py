...
class ESSAdapter(BaseAdapter):
    ...
    def ingest(self, dataset_id: str | None, *, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            aug = {
                b"socdata.dataset_id": f"ess:{dataset_name}".encode("utf-8"),
                b"socdata.source": b"ess",
                b"socdata.adapter": b"ess",
        ...
        try:
            ...
            index_dataset_from_manifest(f"ess:{dataset_name}", str(manifest_path))
        except Exception:
