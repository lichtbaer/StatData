...
class ICPSRAdapter(BaseAdapter):
    ...
    def ingest(self, dataset_id: str | None, *, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            aug = {
                b"socdata.dataset_id": f"icpsr:{dataset_name}".encode("utf-8"),
                b"socdata.source": b"icpsr",
                b"socdata.adapter": b"icpsr",
        ...
        try:
            ...
            index_dataset_from_manifest(f"icpsr:{dataset_name}", str(manifest_path))
        except Exception:
