...
class CSESAdapter(BaseAdapter):
    ...
    def ingest(self, dataset_id: str | None, *, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            aug = {
                b"socdata.dataset_id": f"cses:{dataset_name}".encode("utf-8"),
                b"socdata.source": b"cses",
                b"socdata.adapter": b"cses",
        ...
        try:
            ...
            index_dataset_from_manifest(f"cses:{dataset_name}", str(manifest_path))
        except Exception:
