...
class ISSPAdapter(BaseAdapter):
    ...
    def ingest(self, dataset_id: str | None, *, file_path: str) -> pd.DataFrame:
        ...
        try:
            ...
            aug = {
                b"socdata.dataset_id": f"issp:{dataset_name}".encode("utf-8"),
                b"socdata.source": b"issp",
                b"socdata.adapter": b"issp",
        ...
        try:
            ...
            index_dataset_from_manifest(f"issp:{dataset_name}", str(manifest_path))
        except Exception:
